...
const CRAWL_TARGETS = [
  {
    key: "5v5",
    url: "https://swgoh.gg/gac/counters/?season=5v5",
    outputFile: "gac-5v5.json",
  },
  {
    key: "3v3",
    url: "https://swgoh.gg/gac/counters/?season=3v3",
...
async function crawlGAC(browser, target) {
  ...
  try {
    ...
    console.error(`[${target.key}] ❌ 크롤링 오류:`, err.message);

    // 오류 시 빈 구조로 저장 (앱이 깨지지 않도록)
    const fallback = {
      type: target.key,
      season: "",
      totalBattles: "",
